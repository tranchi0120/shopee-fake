...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar">
      <div
        className={` ${OpenSidebar ? "translate-x-[0]" : "translate-x-[-200%]"
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <button className="g h-[60px]" onClick={handleCloseSidebar}>
            <i className="ri-close-line text-[20px]"></i>
          </button>
        </div>
        <div>
          <ul className="flex px-3 flex-col gap-8 mt-[20px] overflow-y-scroll h-[800px] whitespace-nowrap cart-list ">
